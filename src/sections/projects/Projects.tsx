  ...
  return (
    ...
    >
      <Container className="py-24 sm:py-28 lg:py-20">
        ...
        <Reveal className="mt-12 lg:mt-10">
          <article className="grid overflow-hidden rounded-[2rem] border border-border bg-surface text-foreground shadow-2xl shadow-primary/10 lg:grid-cols-[0.8fr_1.2fr]">
            <div className="flex flex-col justify-center p-7 sm:p-10 lg:p-8">
              ...
              <h3 className="mt-6 text-3xl font-semibold tracking-tight sm:text-5xl lg:text-4xl">
              ...
              <a
                className="mt-6 inline-flex w-fit items-center gap-2 text-sm font-semibold text-foreground transition-colors hover:text-primary"
                href="#contacto"
              >
            ...
            <div className="relative min-h-[22rem] overflow-hidden border-t border-border bg-[radial-gradient(circle_at_70%_25%,rgb(22_119_255_/_0.18),transparent_18rem)] p-6 sm:p-10 lg:border-t-0 lg:border-l lg:p-8">
              ...
              <div className="relative mx-auto max-w-2xl rotate-[-2deg] overflow-hidden rounded-2xl border border-border bg-background/95 shadow-2xl">
                ...
                <div className="grid min-h-72 grid-cols-[4rem_1fr] sm:grid-cols-[8rem_1fr]">
